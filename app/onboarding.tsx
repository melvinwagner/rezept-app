...
const styles = StyleSheet.create({
  ...
  skipText: { fontSize: 12, fontFamily: fonts.bodySemi, color: C.inkSoft, letterSpacing: 0.2 },
  ...
  backText: { fontSize: 14, fontFamily: fonts.bodySemi, color: C.inkSoft, padding: 10 },
  ...
  nextBtnText: { color: "#fff", fontSize: 13, fontFamily: fonts.bodyBold, letterSpacing: 0.3 },
  ...
  monogramD: { fontSize: 16, fontFamily: fonts.displayBlack, color: C.gold },
  eyebrow: {
    fontSize: 9.5,
  ...
  nameBtnLabel: { color: "#fff", fontSize: 14.5, fontFamily: fonts.bodyExtraBold, letterSpacing: 0.1 },
  nameBtnHint: {
  ...
  nameModalTitle: { fontSize: 20, fontFamily: fonts.displayBlack, color: C.ink, letterSpacing: -0.4 },
  ...
  nameModalBtnText: { color: "#fff", fontSize: 14, fontFamily: fonts.bodyBold, letterSpacing: 0.3 },
  nameModalCancel: { marginTop: 6, paddingVertical: 10, alignItems: "center" as any } as any,
  nameModalCancelText: { color: C.inkSoft, fontSize: 13, fontFamily: fonts.bodySemi },
  loginBtnIcon: { width: 20, height: 20, alignItems: "center", justifyContent: "center" },
  loginBtnIconText: { fontSize: 16, fontFamily: fonts.bodyExtraBold },
  loginBtnLabel: { flex: 1, fontSize: 14.5, fontFamily: fonts.bodyBold, letterSpacing: 0.1 },
  ...
  ctaMockText: { color: "#fff", fontSize: 13, fontFamily: fonts.bodySemi, letterSpacing: 0.3 },
  ...
  supportText: { fontSize: 10, color: C.inkMute, fontFamily: fonts.bodyMedium },
  recipeThumb: {
    width: 60,
    height: 72,
    borderRadius: 10,
  ...
  creatorText: { fontSize: 7.5, color: "rgba(255,255,255,0.85)", fontFamily: fonts.bodySemi },

  // Slide 4 - Nährwerte
  ingHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 10 },
  ingTitle: { fontSize: 14, fontFamily: fonts.bodyBold, color: C.ink },
  servingBadge: {
    flexDirection: "row",
    alignItems: "center",
    gap: 6,
  ...
  servingBtn: { color: "#fff", fontSize: 12, fontFamily: fonts.bodySemi, width: 16, textAlign: "center" as any },
  servingText: { color: "#fff", fontSize: 12, fontFamily: fonts.bodyBold },
  ingRow: {
    flexDirection: "row",
    gap: 8,
    alignItems: "center",
  ...
  ingAmount: { width: 38, fontSize: 13, fontFamily: fonts.bodyBold, color: C.ink, textAlign: "right" as any },
  ...
  macroLabel: { fontSize: 10, fontFamily: fonts.bodyBold, color: C.inkSoft, letterSpacing: 0.4 },
  macroLive: { fontSize: 9, fontFamily: fonts.bodySemi, color: C.inkMute, letterSpacing: 0.2 },
  ...
  macroValue: { fontSize: 15, fontFamily: fonts.bodyBold, color: C.accentDeep },
  ...
  microName: { fontSize: 11, color: C.ink, fontFamily: fonts.bodySemi },
  microValue: { fontSize: 10, color: C.inkSoft, fontFamily: fonts.bodyMedium },
  ...
  allergenText: { fontSize: 11, fontFamily: fonts.bodySemi, color: "#9B3E22" },
  ...
  gemueseName: { fontSize: 18, fontFamily: fonts.bodyExtraBold, color: C.ink, letterSpacing: -0.3 },
  ...
  factEdition: { fontSize: 8, fontFamily: fonts.bodySemi, color: C.inkMute, letterSpacing: 0.4 },
  ...
  factNumber: { fontSize: 40, fontFamily: fonts.bodyExtraBold, color: C.accentDeep, letterSpacing: -1.6, lineHeight: 40 },
  factNumberSmall: { fontSize: 12, fontFamily: fonts.bodyBold },
  factWord: { fontSize: 26, fontFamily: fonts.bodyExtraBold, color: C.accentDeep, letterSpacing: -1, lineHeight: 32 },
  factSub: { fontSize: 10, fontFamily: fonts.bodyMedium, color: C.inkSoft, lineHeight: 13, marginTop: 4 },
  factBottom: {
    marginTop: 12,
    paddingTop: 10,
    borderTopWidth: 0.5,
  ...
  bookEyebrow: { fontSize: 6, color: "rgba(255,255,255,0.55)", fontFamily: fonts.bodyBold, letterSpacing: 1.5, textTransform: "uppercase" as any },
  bookName: { fontSize: 13, fontFamily: fonts.displayBlack, color: "#fff", lineHeight: 14, letterSpacing: -0.3, marginTop: 2 },
  ...
  coverCrestLetter: { color: C.gold, fontSize: 20, fontFamily: fonts.displayBlack },
  coverDiv: {
    position: "absolute" as any,
    left: "14%" as any,
    right: "14%" as any,
  ...
  coverStatVal: { color: "#fff", fontSize: 16, fontFamily: fonts.displayBlack },
  coverStatLbl: { color: "rgba(244,216,143,0.5)", fontSize: 6, fontFamily: fonts.bodyBold, letterSpacing: 1, marginTop: 2 },
  coverEdition: {
    position: "absolute" as any,
    bottom: 8,
    left: 0,
  ...
  pickerChipText: { fontSize: 11, fontFamily: fonts.bodyBold, color: C.ink, letterSpacing: 0.2 },
  ...
  ctaFinalText: { color: "#fff", fontSize: 15, fontFamily: fonts.bodyBold, letterSpacing: 0.3 },
  ctaHint: {
    textAlign: "center" as any,
    marginTop: 8,
    fontSize: 11,
